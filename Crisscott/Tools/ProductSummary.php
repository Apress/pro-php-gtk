...
class Crisscott_Tools_ProductSummary extends GtkTable {
    ...
    public function displaySummary(Crisscott_Product $product)
    {
		...
		if ($this->productImage->get_child()) {
    ...
    /**
     * Returns the currently shown product.
     *
     * @access public
    ...
    /**
     * Loads the current product for editing.
     *
     * @access public
     * @return void
     */
    public function editProduct()
    {
        ...
        $productEdit = Crisscott_Tools_ProductEdit::singleton();
        
        $productEdit->loadProduct($this->product);
    }
