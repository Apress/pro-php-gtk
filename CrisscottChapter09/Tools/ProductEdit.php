...
class Crisscott_Tools_ProductEdit extends GtkTable {
	...
	private function _layout()
	{
		...
		$this->descView->set_size_request(300, 300);
		...
		// Attache the description widgets.
		$this->attachWithAlign($this->descLabel,      2, 3, 0, 1,  Gtk::FILL, 0);
		$this->attachWithAlign($this->descView,       2, 4, 1, 11, Gtk::FILL, 0);
	...
	public function resetProduct()
	{
		...
		if (!isset($this->product)) {
			...
			$this->loadProduct(new Crisscott_Product());
		}
